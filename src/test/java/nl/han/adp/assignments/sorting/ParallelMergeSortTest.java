...
import nl.han.adp.assignments.algorithms.sorting.ParallelMergeSort;
...
public class ParallelMergeSortTest {
    ...
    void shouldSortLijstAflopend2() {
        var algorithm = new ParallelMergeSort<Integer>(new AscendingComparator<>());
    ...
    void shouldSortLijstOplopend2() {
        var algorithm = new ParallelMergeSort<Integer>(new DescendingComparator<>());
    ...
    void shouldSortLijstFloat() {
        var algorithm = new ParallelMergeSort<Double>(new AscendingComparator<>());
    ...
    void shouldSortRandomlyGeneratedDescendingDataset() {
        ...
        var data = DataGenerator.generateIntegerDataset(10_000_000);
